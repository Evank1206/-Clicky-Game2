...
class Game extends Component {
    ...
    constructor() {
      ...
      start = () => {
        //   console.log("helloo it's clicked");
    ...
    render() {
        ...
        return (
            <div>
                <button className="button" onClick={this.start} href="/">Start</button>
                ...
                {this.state.imgArr.map((image, index) => (
                    // console.log(image)
                    // console.log(index)
                    <Click id={image.num} src={image.imgUrl} func={this.incrementScore}/>
                ...
                <footer className="footer"><a href="https://github.com/Evank1206">#Evank</a> &copy;Right 2020</footer>
